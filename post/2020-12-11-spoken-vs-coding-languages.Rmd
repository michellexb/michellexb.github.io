...
author: Michelle Bao
date: '2020-12-11'
slug: spoken-vs-coding-languages
categories: []
tags: []
description: ''
---
...
For example, it is easier for me to remember the English word for "avocado" than the Chinese one, just like how it's easier for me to remember how to find mean in R, over Python.
```{r}
data <- c(2.5, -1, -12, 7.5)
mean(data)
```
